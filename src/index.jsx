...
const store = applyMiddleware(promise)(createStore)(reducers, devTools);        //quando usamos o middleware, ao passarmos uma promise para ele, ele irá esperar a promise carregar os dados para então passar essas informações adiante para o payload
ReactDOM.render(
